  ...
  return (
    <div className={styles.body}>
      <div className={styles.left}>
        <h1 style={{fontFamily:"Single Day"}}>Super app</h1>
        <p className={styles.choosing}>Choose your<br/>entertainment<br/>category</p>
      ...
      <button className={styles.btn1} onClick={handlenextpage}>Next Page</button>
    </div>
  )
}
